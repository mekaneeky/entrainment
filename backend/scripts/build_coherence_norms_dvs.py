...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build expanded Z-score norms/cutoffs from DVS ds005385.")
    parser.add_argument("--dataset", type=Path, default=Path("data/ds005385"), help="Local ds005385 directory")
    parser.add_argument("--glob", type=str, default="sub-*/ses-1/eeg/*_task-EyesClosed_acq-pre_eeg.edf", help="EDF/FIF glob")
    ...
    parser.add_argument("--min-age-bin-n", type=int, default=10, help="Minimum samples required for per-age-bin stats")
    parser.add_argument("--task-label", type=str, default="EyesClosed", help="Task label stored in metadata")
    parser.add_argument("--acquisition-label", type=str, default="pre", help="Acquisition label stored in metadata")
    parser.add_argument("--dataset-label", type=str, default="dvs_608", help="Dataset label stored in metadata")
    parser.add_argument(
        "--output",
        type=Path,
    ...
    out = {
        ...
        "acquisition": str(args.acquisition_label),
        "notes": "DVS ds005385 expanded norms. Cutoffs are mean +/- 2 SD.",
